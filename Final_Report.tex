...
The blue shaded region denotes the primary sample period (July 2025--March 2026), characterised by elevated implied volatility associated with trade policy uncertainty and tariff announcements. 
The orange shaded region indicates the historical comparison period (May--October 2023), during which volatility remained subdued, reflecting stable investor sentiment and limited geopolitical stress.}
\label{fig:vix_5yr}
\end{figure}
