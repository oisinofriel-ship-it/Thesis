...
\caption{Daily closing values of the CBOE Volatility Index (VIX) from March 2021 to March 2026. The blue shaded region denotes the primary sample period (July 2025--March 2026), which coincides with elevated implied volatility driven by trade policy uncertainty and successive tariff announcements. The orange shaded region marks the historical comparison period (May--October 2023), during which the VIX remained broadly within its historical average range, reflecting stable investor sentiment and an absence of the sustained, policy-driven elevations that characterise the primary sample period.}
\label{fig:vix_5yr}
\end{figure}
